...
//innerHTML
innersExample.innerHTML += '<h2>Le agrego este elemento mediante innerHTML</h2>'
...
articleContainer.innerHTML += generadorArticulos('Este es el titulo del primer articulo', 'Esta es la descripción del primer articulo')
articleContainer.innerHTML += generadorArticulos('Este es el titulo del segundo articulo', 'Esta es la descripción del segundo articulo')
articleContainer.innerHTML += generadorArticulos('Este es el titulo del tercero articulo', 'Esta es la descripción del tercero articulo')
